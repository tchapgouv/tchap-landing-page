			...
			<div className="tc_Tac">
				...
				<Container maxWidth="lg">
					...
					<div className="tc_paragraph">
						...
						<div className="tc_subparagraph"><strong>Tchap</strong> se base sur l’adresse email des utilisateur : elle peut être installée sur autant de téléphones que l’on souhaite (pro et perso) et toutes les sessions partagent en temps réel les échanges. De plus, Tchap est également accessible depuis un navigateur web, sur ordinateur.</div>
						<h4 id="4-Offre-de-support-personnalisé-par-l’équipe-Tchap">4. Offre de support personnalisée par l’équipe Tchap</h4>

						<div className="tc_subparagraph">L’équipe DINUM peut proposer une assistance personnalisée aux équipes supports et une aide au déploiement de la solution. Elle organise régulièrement des webinaires.<br/>
						...
						<div className="tc_subparagraph">L’équipe est en lien rapproché avec l’Agence National de Santé et Opérateur des Systèmes d’Information Interministériels Classifiés pour partager les connaissances et mettre en commun les compétences techniques. Elle échange ainsi de manière régulière avec l’ANSSI qui accompagne le développement de Tchap.</div>
						<div className="tc_subparagraph">Tchap travaille avec l’Agence numérique en santé pour développer une messagerie interopérable pour sécuriser les échanges entre les professionels de santé.</div>
					...
					<div className="tc_paragraph">
						<h3 id="Roadmap-2024">Roadmap 2024</h3>
